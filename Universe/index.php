...
<link rel="stylesheet" href="assets/css/space.css" type="text/css">
		<script type="text/javascript">
			$(function () {
			$('#countdown').countdown({until:$.countdown.UTCDate(-8,2013,2- 1, 17), format: 'DHMS', layout: 
									  '<div id="timer">' +
	...
	<body>
		<p id="universe">
			...
			<div id="container">
				<div id="nit">
					<br><font size=72><center>NAKSHATRA'12</font>
				</div>
				<div id="nit">
					<span><center>National Institute Of Technology,Calicut</span>
				</div>
				<div id="wrapper">
